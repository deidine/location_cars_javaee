					...
					<div class="container">
						<div class="row d-flex align-items-start">
							...
							<div class="col-4 bg-custom  d-lg-block py-3 px-0 ml-5">
								...
								<input type="hidden" name="villeFinDebut" value="ville">
									<fieldset>
										<!-- Ville -->
...
<!-- End Image Carousel -->
	...
	<div class="container">
		<div class="row my-3">
			...
			<div class="col-md-4 my-4 center-block" style="text-align:center;" >
				<a href="" class="client-img"  ><img width="80" heigth="90" src="res/img/statistics.svg" alt="assurance" ></a>
				<h4 class="my-4">Statistiques</h4>
				<br>
				<p></p>
							<a href="${pageContext.request.contextPath}/ShowStats" class="btn btn-outline-dark btn-md">Lire la suite</a>
			</div>
		</div>
	</div>
