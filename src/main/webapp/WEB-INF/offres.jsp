...
<link rel="shortcut icon"
	href="${pageContext.request.contextPath}/res/img/favicon.png">
<!-- Bootstrap 4.5 CSS -->
<link rel="stylesheet"
...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/res/css/offres.css">
<link rel="stylesheet"
	...
	<main role="main">
		...
		<section class="jumbotron text-center">
			<div class="container">
				...
				<p class="lead text-muted">Profiter des offres dans toutes les
					villes du Maroc.</p>
	...
	<div class="album py-5 bg-light">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-3 filter flex-md-column"
					style="box-shadow: 0px 0px 10px rgba(0, 0, 0, .4); border-radius: 20px;">
					<!-- Filtrage ---------------------->
					<form method="post" action="fillter1">
						<hr>
						<div class="aside" style="margin-top: 30px;">
							<input type="hidden" value="Fillter">
							<!-- Par prix -->
							<p style="font-weight: bold; margin-left: 12px;">Prix par
								jour (Um)</p>
							<section>

								<label for="prix_min">Min</label> <input type="text"
									id="prix_min" name="prixMin" class="form-control" value="">
								<label for="prix_max">Max</label> <input type="text"
									id="prix_max" name="prixMax" class="form-control" value="">
	...
	<!-- 
						<div class="aside" style="margin-top: 5px;">
							<section>
								<div style="margin-left: -10px; margin-top: -8px; padding: 2em;">
									<p style="font-weight: bold; margin-left: 12px;">Type du
										véhicule</p>
					  ...
					  <div class="aside" style="margin-top: 5px;">
		            		...
		            		<section>
								...
								<input type="text"
									id="prix_min" name="marque" class="form-control" value="">
		            			</div>
		            		</section>
		            ...
		            <hr>  -->
						<div class="aside" style="margin-top: 5px;">
							<section>
								<div style="margin-left: -10px; margin-top: -8px; padding: 2em;">
									<p style="font-weight: bold; margin-left: 12px;">Boîte de
										vitesse</p>
		            ...
		            -->
						<div class="aside" style="margin-top: 5px;">
							...
							<section>
								...
								<label for="km_min">Min</label> <input type="text" id="km_min"
									class="form-control" name="kmMin" value=""> <label
									for="km_max">Max</label> <input type="text" id="km_max"
									class="form-control" name="kmMax" value="">
				...
				<div class="col-9 offre">
					...
					%>
					<p>
						<c:out value="<%=voiture.size()%>"></c:out>
						résultats trouvés
					</p>
						...
						<div class="col-sm-6">
							<div class="card mb-4 box-shadow">
								<a type="submit" style="border: none;"
									...
									src="res/voiture/<%=v.getPHOTO1()%>" alt="Car image">
								</a>

								<div class="card-body"
									style="font-family: 'Montserrat', sans-serif;">
									<p class="card-text" style="font-weight: bold;"><%=v.getMarque()%>,
										&nbsp
										<%=v.getModele()%></p>
									<p class="card-text"><%=v.getLieu_rencontre()%>, &nbsp
										<%=v.getVille()%></p>
									<p class="card-text"><%=v.getPrix()%>
										Dirhams/jour
									</p>
									<div class="d-flex justify-content-between align-items-center">
										<div class="btn-group">
											<a
												href="offre?action=voiroffre&id_vehicule=<%=v.getId_vehicule()%>">
												<input type="button" value="Decouvrir l'offre"
