...
<%@page import="com.dao.implementations.ChatDao"%>

<nav class="navbar bg-#0C1248 navbar-#0C1248 navbar-expand-lg">
	<div class="container-fluid">
		<a href="Home" class="navbar-brand"><img
			style="height: 80px; width: 200px;" src="res/img/new-logo.jpeg"
...
<li class="nav-item">
				<a href="${pageContext.request.contextPath}/ChatServlet?receiver=<%=userId %>" class="client-img"><img width="80" heigth="90"
					src="res/img/chat.svg" alt="assurance"></a><%= totalchat%>
</li>
				<li class="nav-item"><a href="logout"><svg xmlns="http://www.w3.org/2000/svg"
