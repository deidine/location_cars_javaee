...
public class UserDaoImp implements UserDao {
	...
	ResultSet rs = null;
	connection =DBconnection.getConnection();
	String query="select PASSWORD,EMAIL from utilisateur where EMAIL=? and PASSWORD =?";
	try {
	...
	public int getCountUsers() {
		 int u = 0;
	        try {
	            ...
	            PreparedStatement ps = con.prepareStatement("select count(*)as total from utilisateur");
