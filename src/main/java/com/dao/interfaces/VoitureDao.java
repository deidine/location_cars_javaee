...
public interface VoitureDao {
	...
	public List<Voiture> findFillterVoiture(int maxprix,int minprix,int minkillometrage,int maxkillometrage,String Fboite_vitesse,String marque) throws SQLException;
